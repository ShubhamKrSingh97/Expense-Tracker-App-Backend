...
document.addEventListener('DOMContentLoaded',async (e)=>{
    ...
    try{
   const res= await axios.get("/premium/reports/yearly",{headers:{'Authorization': token }});
...
dropDown.addEventListener('change',async (e)=>{
    ...
    try{
        const res=await axios.get(`/premium/reports/monthly`,{headers:{'Authorization':token,'month':month}});
        console.log(res);
...
downloadReportsBtn.addEventListener('click',async (e)=>{
    ...
    try{
        ...
        const res=await axios.get("/premium/reports/download",{headers:{'Authorization':token,'month':month}});
